...
namespace LaTeXAPI
{
    ...
    public class ClientController : ControllerBase
    {
        ...
        public IResult SendMessageCode_Identity(SendIdentityMessageCodeRequest request)
        {
            ...
            try
            {
                _messagecode.SendVerifyCode(client.Tel, _configuration.GetSection("AliYun").GetSection("Message").GetSection("TemplateCode_Identity").Value);
                _re.result = IResult.ResultType.success;
                _re.detail = new Dictionary<string, string>
                {
        ...
        public IResult SendMessageCode_Login(SendLoginMessageCodeRequest request)
        {
            try
            {
                _messagecode.SendVerifyCode(request.tel, _configuration.GetSection("AliYun").GetSection("Message").GetSection("TemplateCode_Login").Value);
                _re.result = IResult.ResultType.success;
                _re.detail = new Dictionary<string, string>
                {
