...
$(function () {
  _theme.theme_except_latex.init_navLink("#btn_update");
  ...
  _verify.LoginVerify.isLogined(false).then(function () {
    _update.update.init(update_opt);
...
var update = exports.update = {
  ...
  getUpdateJSON: function getUpdateJSON() {
    var path = Config[Environment].Boot_OSS + "/json/log_update.json";
    var pro = new Promise(function (resolve, reject) {
      $.ajax({
        url: path,
        success: function success(data) {
  ...
  makeLog: function makeLog(arr) {
    var wrap = document.getElementById("wrap-update-log");
